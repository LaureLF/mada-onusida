...
GRAVITE = (('1', "1 (C'est un détail)"), ('2','2'), ('3','3 (Important)'), ('4','4'), ('5','5 (Essentiel)'))
...
class Feedback(models.Model):
    ...
    description = models.TextField(blank=False, null=False, default="", verbose_name="Quel a été le problème rencontré ? Merci de décrire précisément l'action que vous étiez en train d'effectuer")
