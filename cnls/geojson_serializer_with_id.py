...
class GeojsonWithIdSerializer(GeojsonSerializer):
    ...
    def get_dump_object(self, obj):
        ...
        fields_to_remove = {'objectif', 'duree', 'createur', 'commentaire', 'montant_prevu', 'montant_disponible', 'devise', 'origine', 'contact', 'operateur', 'resultat_cf_annee_ant', 'priorite_psn', 'creation', 'maj', 'login_maj', 'validation'}
